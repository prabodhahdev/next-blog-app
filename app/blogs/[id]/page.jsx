  ...
  return ( data?<>
   ...
   <p className='mt-1 pb-2 text-lg max-w-[740px] mx-auto'>{data.author}</p>
    ...
    <div className="mx-5 max-w-[800px] md:mx-auto mt-[-100px] mb-10">
      ...
      <h3 className='my-5 text-[18px] font-semibold'>step:1 Lorem ipsum dolor sit amet.</h3>
      <p className='my-3'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate autem sunt maiores obcaecati iste rerum.</p>
      <p className='my-3'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate autem sunt maiores obcaecati iste rerum.</p>


      <h3 className='my-5 text-[18px] font-semibold'>step:2 Lorem ipsum dolor sit amet.</h3>
      <p className='my-3'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate autem sunt maiores obcaecati iste rerum.</p>
      <p className='my-3'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate autem sunt maiores obcaecati iste rerum.</p>
